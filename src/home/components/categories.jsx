...
function Categories() {
   return (
      <div className='my-[100px] h-auto flex flex-col gap-5'>
         ...
         <div className='flex flex-col md:flex-row md:justify-center md:gap-10 mx-auto mt-10'>
            ...
            <div className='flex flex-col items-center'>
               <img src={image2} alt="bed-room" className="w-full h-auto" />
            ...
            <div className='flex flex-col items-center'>
               <img src={image3} alt="dining-room" className="w-full h-auto" />
