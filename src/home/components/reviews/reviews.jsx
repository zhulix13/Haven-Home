...
function Reviews() {
  return (
    <div className="mt-14 flex flex-col py-10 gap-8 mx-auto items-center h-auto max-w-[1200px]">
      {/* Section Title */}
      <h1 className="font-clash text-[45px] font-bold text-center md:text-[45px]">
      ...
      {/* Reviews Section */}
      <div className="grid mx-auto gap-y-10 md:gap-y-14 gap-x-5 grid-cols-1 md:grid-cols-3 mt-8">
        {reviewsList.map((review) => (
          <div className="flex flex-col gap-6 pt-8 shadow-inset-dark rounded-3xl px-6 py-8 justify-evenly border border-[#E0EAFE] transition-transform hover:scale-[1.02]">
            ...
            <h1 className="font-sans font-regular text-xl md:text-xl px-4 text-center">
              {`"${review.message}"`}
            </h1>
            <div className="flex items-center justify-evenly gap-4">
              ...
              <div className="font-sans flex flex-col items-center gap-2 font-bold text-xl md:text-xl">
      ...
      <div className="mt-16">
        <h1 className="font-bold font-clash text-[35px] text-center md:text-[45px]">
